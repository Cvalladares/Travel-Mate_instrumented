...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
                ...
                builder.setMessage(R.string.signout_message)
                        .setPositiveButton(R.string.positive_button,
                                (dialog, which) -> {
                                    ...
                                    PrefetchingLib.notifyExtras(i.getExtras());
                                    startActivity(i);
                                    finish();
                                })
    ...
    private void fillNavigationView(String emailId, String imageURL) {
        ...
        imageView.setOnClickListener(v -> {PrefetchingLib.notifyExtras(ProfileActivity.getStartIntent(MainActivity.this).getExtras());
    ...
    private void getProfileInfo() {
        ...
        //Set up client
        OkHttpClient client = PrefetchingLib.getOkHttp();
